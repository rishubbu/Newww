...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "ganaasupport")
...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/rishubbu/Newww")
...
GITHUB = os.getenv("GITHUB", "https://github.com/rishubbu/Newww")
